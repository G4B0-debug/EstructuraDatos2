...
public class Banco {
    ...
    public void agregarCliente(Cliente cliente) {
        if (cliente.getTipo().equals("conCuenta")) {
            if (esPrioritario(cliente.getNumeroCuenta())) {
                colaConCuenta.enqueuePriority(cliente); // Agrega con prioridad
            } else {
    ...
    private boolean esPrioritario(String numeroCuenta) {
        return numeroCuenta.equals("042") || numeroCuenta.equals("022") || numeroCuenta.equals("011");
    }
